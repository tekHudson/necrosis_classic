...
function Necrosis_Initialize()
	...
	if UnitClass("player") ~= NECROSIS_UNIT_WARLOCK then
		...
		NecrosisTimerBarHeight_Slider:SetValue(NecrosisConfig.TimerBarHeight);
		NecrosisTimerBarHeight_SliderLow:SetText("100%");
		NecrosisTimerBarHeight_SliderHigh:SetText("200%");
...
function Necrosis_LanguageInitialize()
	...
	NecrosisTimerBarHeight_SliderText:SetText(NECROSIS_CONFIGURATION.TimerBarHeight);
